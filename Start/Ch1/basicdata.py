...
with open("/workspaces/hands-on-advanced-python-2703239/sample-weather-history.json", "r") as weatherfile:
...
print(f"The warmest day was {coldday['date']} at {coldday['tmin']} degree")

# TODO: How many days had snowfall?
snowdays = [day for day in weatherdata if day['snow'] >0]
print(f"Snow feel on {len(snowdays)} days")
pprint.pp(snowdays)